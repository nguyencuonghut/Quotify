...
Trước khi bắt đầu bất kỳ task nào, Gemini phải đọc theo thứ tự:
...
```bash
bash scripts/agent-task-close.sh --agent gemini --title "<ten task>" --summary "<tom tat ben vung>"
```

Nếu `GEMINI.md` và `AGENTS.md` có điểm nào mâu thuẫn, `AGENTS.md` là nguồn sự thật cao hơn.
